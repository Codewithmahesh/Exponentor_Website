...
export default function XsitePage() {
  return (
    <main className="min-h-screen" style={{ background: "radial-gradient(ellipse 80% 40% at 50% 0%, #1C0F3E 0%, #07070F 60%)" }}>

      {/* Back nav */}
      <div className="px-8 pt-8 max-w-[1200px] mx-auto">
        <Link href="/" className="inline-flex items-center gap-2 text-gray-600 hover:text-violet-400 text-sm transition-colors duration-200 group">
      ...
      <section className="px-8 pt-20 pb-28 max-w-[1200px] mx-auto text-center">
        ...
        <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.45 }} className="flex gap-4 justify-center">
          ...
          <Link href="#how-it-works" className="px-7 py-3.5 rounded-full border border-[#2A2A3E] text-gray-400 hover:text-white hover:border-violet-500/40 font-semibold text-sm transition-all duration-200">
            How it works
          </Link>
        </motion.div>
      </section>
          ...
          {steps.map((s, i) => (
            <Section key={s.n}>
              <motion.div
                ...
                className="h-full p-8 rounded-2xl border border-[#1F1F35] bg-[#0D0D1A] flex gap-6"
              >
          ...
          {features.map((f, i) => (
            <Section key={f.title}>
              <motion.div
                ...
                transition={{ duration: 0.3 }}
                className="h-full p-6 rounded-2xl border border-[#1F1F35] bg-[#0D0D1A]"
              >
      ...
      <section className="px-8 py-24 max-w-[1200px] mx-auto">
        <Section>
          <div className="rounded-3xl border border-violet-500/25 bg-gradient-to-br from-violet-900/20 to-[#0D0D1A] p-12 md:p-16 text-center relative overflow-hidden">
